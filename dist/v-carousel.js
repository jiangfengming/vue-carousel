  ...
  methods: {
    ...
    onPanEnd: function onPanEnd() {
      ...
      if (this.panOffset !== this.offset || this.transitionOffsets.indexOf(this.offset) === -1) {
        var offset;
        var p0 = this.panTracks.shift();
        var p1 = this.panTracks.pop();
        var v0 = Math.abs(p1.position - p0.position) / Math.abs(p1.timeStamp - p0.timeStamp);
        var nextOffset = this.getOffset(this.panOffset, this.panOffset < this.offset ? 'left' : 'right');
        var vMin = a * Math.sqrt(2 * Math.abs(nextOffset - this.panOffset) / a);
      ...
      if (page != null && !this.animating && !this.panning && this.transitionOffsets.length) {
        ...
        if (to !== this.offset) {
          if (immediate) {
            ...
            var v0 = a * Math.sqrt(2 * Math.abs(to - this.offset) / a);
...
__vue_render__$1._withStripped = true;
  ...
  const __vue_inject_styles__$1 = function (inject) {
    if (!inject) return
    inject("data-v-2be0fa70_0", { source: "\n.slide[data-v-2be0fa70] {\n  flex-shrink: 0;\n}\n", map: {"version":3,"sources":["/Users/jfm/projects/v-carousel/src/VSlide.vue"],"names":[],"mappings":";AAgCA;EACA,cAAA;AACA","file":"VSlide.vue","sourcesContent":["<template>\n  <div class=\"slide\"><slot /></div>\n</template>\n\n<script>\nimport elementResizeDetectorMaker from 'element-resize-detector'\n\nexport default {\n  name: 'VSlide',\n  inject: ['carousel'],\n\n  mounted() {\n    this.carousel.$emit('slide-resize')\n\n    this.resizeDetector = elementResizeDetectorMaker({\n      strategy: 'scroll',\n      callOnAdd: false\n    })\n\n    this.resizeDetector.listenTo(this.$el, () => {\n      this.carousel.$emit('slide-resize')\n    })\n  },\n\n  destroyed() {\n    this.resizeDetector.uninstall(this.$el)\n    this.carousel.$emit('slide-resize')\n  }\n}\n</script>\n\n<style scoped>\n.slide {\n  flex-shrink: 0;\n}\n</style>\n"]}, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$1 = "data-v-2be0fa70";
  /* module identifier */
...
export { __vue_component__ as VCarousel, __vue_component__$1 as VSlide };
